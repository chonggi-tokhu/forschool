...
schoolClass.prototype = {
    ...
    setJSON(jsonstr){
        ...
        this.studentnames = Array.isArray(parsed)?parsed.map((val,idx,arr)=>{return arr.map((val1,idx1,arr1)=>{if (idx===val1.numb-1){console.log(idx); console.log(val1.numb-1); return val1.name}}).map((val1,idx1,arr1)=>{if (val1!==undefined){return val1}})[0];}):this.studentnames;
        this.names = this.studentnames;
