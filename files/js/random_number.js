...
schoolClass.prototype = {
    ...
    setJSON(jsonstr){
        ...
        this.studentnames = Array.isArray(parsed)?parsed.length===this.studentnames.length?parsed.map((val,idx,arr)=>{return arr[val.numb].name}):this.studentnames:this.studentnames;
